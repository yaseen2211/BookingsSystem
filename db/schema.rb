...
ActiveRecord::Schema.define(version: 20170809170242) do
  ...
  add_index "cleaners", ["city_id"], name: "index_cleaners_on_city_id"
  ...
  add_index "customers", ["city_id"], name: "index_customers_on_city_id", unique: true
